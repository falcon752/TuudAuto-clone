  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-8 items-start z-10 px-4 lg:px-10">
        <motion.div
          className="lg:pl-0 pl-2"
          initial="hidden"
          animate="visible"
          transition={{ staggerChildren: 0.15 }}
        >
          <motion.div
            className="inline-flex items-center gap-2 md:gap-3 bg-white/20 text-white px-4 md:px-6 py-2 md:py-3 rounded-lg border-2 border-white/80 mb-4 font-semibold text-sm md:text-base"
            variants={pop}
          >
          ...
          <motion.h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-[96px] font-extrabold leading-none mb-4"
            variants={fadeUp}
          >
          ...
          <HeroSubline />
          <motion.p
            className="text-sm md:text-lg font-bold text-white/90 max-w-xl mb-6"
            variants={fadeUp}
          >
          ...
          <motion.ul
            className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-green-100 font-medium mb-6"
            variants={fadeUp}
          >
            {[
          ...
          <motion.div
            className="flex flex-col sm:flex-row gap-4 md:gap-6 mb-6"
            variants={fadeUp}
          >
            <motion.button
              className="flex items-center gap-2 bg-gradient-to-r from-purple-700 to-pink-600 text-white py-3 md:py-4 px-6 md:px-8 rounded-xl font-semibold text-base md:text-lg"
              variants={pop}
            >
              <FaPhoneAlt /> Get Free Quote
            </motion.button>
            <motion.button
              className="flex items-center gap-2 bg-white text-gray-900 py-3 md:py-4 px-6 md:px-8 rounded-xl font-semibold text-base md:text-lg"
              variants={pop}
            >
        ...
        <motion.aside
          className="bg-white/20 backdrop-blur-lg rounded-3xl p-6 md:p-10 flex flex-col gap-4 min-h-[460px] mt-10 lg:mt-24 text-white shadow-lg border border-white/20"
          initial="hidden"
          animate="visible"
          transition={{ staggerChildren: 0.1 }}
        >
          <motion.h4
            className="text-center text-lg md:text-xl font-bold mb-2"
            variants={fadeUp}
          >
            Why Choose TuudAuto?
          </motion.h4>
          <motion.div
            className="flex justify-center mb-2 text-yellow-400 text-xl md:text-2xl"
            variants={pop}
          >
            <FaStar />
            <FaStar />
          ...
          <motion.div
            className="text-center text-white/70 font-bold mb-4 text-sm md:text-base"
            variants={fadeUp}
          >
            ...
            {[
              {
                ...
                number: "24hrs",
                label: "Response Time",
                color: "text-pink-400 bg-white/10",
              },
              {
                icon: FaShieldAlt,
                number: "98%",
              ...
              return (
                ...
                >
                  <div
                    className={`w-14 h-14 flex items-center justify-center rounded-lg ${kpi.color} mb-2 text-2xl`}
                  >
                    <Icon />
                  </div>
            ...
            {[
              {
                icon: FaShieldAlt,
                text: "Fully Insured",
                color: "text-green-500 bg-green-100/20",
              },
              {
                icon: FaTruck,
                text: "GPS Tracked",
                color: "text-blue-400 bg-blue-100/20",
              },
              {
                icon: FaUserFriends,
                text: "Verified Drivers",
                color: "text-purple-400 bg-purple-100/20",
              },
            ].map((ci, i) => {
              const Icon = ci.icon;
              return (
                <motion.div
                  key={i}
                  className="flex flex-col items-center gap-1 text-xs md:text-sm"
                  variants={pop}
                >
                  <div
                    className={`w-12 h-12 flex items-center justify-center rounded-full ${ci.color}`}
                  >
